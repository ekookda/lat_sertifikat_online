        ...
        <div class="box">
            ...
            <div class="box-body">
				...
				<div class="box-header">
					<legend class="text-primary" style="text-decoration:underline; border-bottom:none">Data Peserta Ujian</legend>
				</div>
				<!-- /.box-header -->
                <table id="myTable" class="table table-responsive table-bordered table-striped">
                    ...
                    if ($data_siswa_sma->num_rows() > 0) {
                        ...
                        echo "<tr><td colspan='7'><h2>".heading('Tidak ada data', 2, 'class="text-center text-info"')."</td></tr>";
                    }
                    ?>
                    </tbody>
                </table>
