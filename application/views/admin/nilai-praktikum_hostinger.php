...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            <table id="example1" class="table table-responsive table-bordered table-striped">
                ...
                if ( $data->num_rows() > 0 ) {
                    ...
                    echo "<th class='text-center' rowspan='2'>Username</th>";
                    echo "<th class='text-center' rowspan='2'>Nama Peserta</th>";
                    ...
                    foreach ( $data->result() as $nilai ) {
                        ...
                        echo "<td class='text-left'>" . ucwords($nilai->username) . "</td>";
                        echo "<td class='text-left'>" . ucwords(strtolower($nilai->nama_lengkap)) . "</td>";
        ...
        <div class="box-body text-right">
            <a href="<?= site_url('c_Admin/certificate'); ?>">
